...
def findAmount():
    ...
    next=0
    validContoursWithData1=validContoursWithData
    for i in range(len(validContoursWithData)-1):
	contourWithdata = validContoursWithData[i]
	contourWithdata1=validContoursWithData[i+1]
	
	contourWithdata.intRectWidth=contourWithdata1.intRectX-contourWithdata.intRectX
	contourWithdata.intRectX=contourWithdata.intRectX-((contourWithdata.intRectWidth)/4)
	contourWithdata.intRectWidth=contourWithdata.intRectWidth+((contourWithdata.intRectWidth)/4)
	...
	#print contourWithData.fltArea
        ...
        number=str(imagecount)+'.png'
        cv2.imwrite(number,imgROIResized)        
