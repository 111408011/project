...
def main():
    ...
    imgTestingNumbers = cv2.imread("AccuracyCalculation.jpg")          # read in testing numbers image
    ...
    for contourWithData in validContoursWithData:            # for each contour
        ...
        retval, npaResults, neigh_resp, dists = kNearest.findNearest(npaROIResized, k = 17)     # call KNN function find_nearest
